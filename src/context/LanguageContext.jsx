...
export const translations = {
  de: {
    ...
    publicWork: {
      ...
      projectDemoNotice: 'Admin-Funktionen sind sichtbar, aber aus Sicherheitsgründen deaktiviert. Für eine vollständige Demonstration kontaktieren Sie uns.',
  ...
  en: {
    ...
    publicWork: {
      ...
      projectDemoNotice: 'Admin features are visible but disabled for security. Contact us for a full demonstration.',
