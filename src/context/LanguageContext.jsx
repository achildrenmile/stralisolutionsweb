...
export const translations = {
  de: {
    ...
    publicWork: {
      ...
      projectDisclaimer: 'Diese Demo dient ausschließlich zur Veranschaulichung und Evaluation – keine Produktionsgarantie oder rechtliche Gewährleistung.',
      projectDemoButton: 'Live Demo',
  ...
  en: {
    ...
    publicWork: {
      ...
      projectDisclaimer: 'This demo is for illustrative and evaluation purposes only – no production guarantees or legal warranties.',
      projectDemoButton: 'Live Demo',
      projectGithubButton: 'GitHub',
