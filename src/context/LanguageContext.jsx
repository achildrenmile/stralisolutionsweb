...
export const translations = {
  de: {
      ...
      ai: {
        ...
        platforms: {
          ...
          items: [
            ...
            { url: 'https://ai4u.strali.solutions/search', name: 'Semantische Suche', description: 'KI-gestützte Vektorsuche' },
    ...
    imprint: {
      ...
      ai: {
        title: 'KI-Systeme und EU AI Act',
        ...
        platforms: {
          ...
          items: [
            ...
            { url: 'https://ai4u.strali.solutions/search', name: 'Semantische Suche', description: 'KI-gestützte Vektorsuche für dokumentenübergreifende Abfragen' },
        ...
        compliance: {
          ...
          text: 'Wir verpflichten uns zur Einhaltung der Transparenzpflichten gemäß Artikel 50 EU AI Act, insbesondere zur klaren Kennzeichnung von KI-Interaktionen und zur Information der Nutzer vor der ersten Interaktion.'
        }
      },
      booking: {
  ...
  en: {
      ...
      ai: {
        ...
        platforms: {
          ...
          items: [
            ...
            { url: 'https://ai4u.strali.solutions/search', name: 'Semantic Search', description: 'AI-powered vector search' },
    ...
    imprint: {
      ...
      ai: {
        title: 'AI Systems and EU AI Act',
        ...
        platforms: {
          ...
          items: [
            ...
            { url: 'https://ai4u.strali.solutions/search', name: 'Semantic Search', description: 'AI-powered vector search for cross-document queries' },
        ...
        compliance: {
          ...
          text: 'We are committed to complying with the transparency obligations under Article 50 of the EU AI Act, particularly the clear labeling of AI interactions and informing users before the first interaction.'
        }
      },
      booking: {
